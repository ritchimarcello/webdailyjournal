<table class="table table-hover">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM user ORDER BY username DESC LIMIT $limit_start, $limit";
                    ...
                    ?>
                        <tr>
                            ...
                            <img src="img/<?php echo $row['foto']; ?>" alt="Foto User" width="100">
                            <?php else: ?>
                                Tidak ada foto
                            <?php endif; ?>
                            </td>
            ...
            <form method="post" action="" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="password" placeholder="Tuliskan password User" value="<?= $row["password"] ?>" required>
                    </div>
                    <div class="mb-3">
                    </div>
                    <div class="mb-3">
